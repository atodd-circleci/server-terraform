...
/sbin/iptables --wait --append $docker_chain -i docker+ --destination "169.254.0.0/16" --jump DROP
/sbin/iptables --wait --append $docker_chain -i br-+ --destination "169.254.0.0/16" --jump DROP

# Blocking internal cluster resources
%{ for cidr_block in blocked_cidrs ~}
/sbin/iptables --wait --append $docker_chain -i docker+ --destination "${cidr_block}" --jump DROP
/sbin/iptables --wait --append $docker_chain -i br+ --destination "${cidr_block}" --jump DROP
%{ endfor ~}
